document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "Ikyy's Api");
        setContent('wm', 'textContent', `© 2025 ${settings.apiSettings.creator}. All rights reserved.` || "© IkyyOfficial. All rights reserved.");
        setContent('header', 'textContent', settings.name || "Ikyy's Api");
        setContent('name', 'textContent', settings.name || "Ikyy's Api");
